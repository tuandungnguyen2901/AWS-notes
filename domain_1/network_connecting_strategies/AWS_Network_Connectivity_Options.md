...
• **AWS PrivateLink / VPC Endpoints**: This enables private connectivity between a VPC and supported AWS services, other VPCs, or endpoint services hosted by other accounts.
